...
- **213 位画家**，其中 **198 位附完整档案**（定位 + 生平 + 代表作），覆盖流派名单的 94%
  - 未建档的 12 项均为匿名创作集体（如贝宁王室铸工行会、玛雅宫廷画师），无个人生平可考，界面中已明确标注
- **601 篇作品逐幅赏析**（看什么、为什么重要）、**140 条术语**
...
| **画家与画作** | 198 位画家档案，每位挂载本人代表作与逐幅赏析；可按时期/流派/地域筛选，支持「按画家」与「按作品」两种浏览模式 |
...
data/painters-a~j.js    198 位画家档案：生平、定位、代表作与逐幅赏析
