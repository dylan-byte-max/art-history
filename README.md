...
- **212 位画家**，其中 **60 位附完整档案**（定位 + 生平 + 代表作）
- **199 篇作品逐幅赏析**（看什么、为什么重要）、**140 条术语**
...
| **画家与画作** | 60 位画家档案，每位挂载本人代表作与逐幅赏析；可按时期/流派/地域筛选，支持「按画家」与「按作品」两种浏览模式 |
...
data/painters-a~c.js    60 位画家档案：生平、定位、代表作与逐幅赏析
