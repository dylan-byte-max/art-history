...
- **46 个流派**，从古埃及到当代，含中国画、日本画/浮世绘、伊斯兰、非洲、前哥伦布美洲
- **220 位画家**，其中 **204 位附完整档案**（定位 + 生平 + 代表作），覆盖流派名单的 94%
  - 未建档的 12 项均为匿名创作集体（如贝宁王室铸工行会、玛雅宫廷画师），无个人生平可考，界面中已明确标注
- **620 篇作品逐幅赏析**（看什么、为什么重要）、**146 条术语**
- **284 张公版馆藏图**，来自 The Metropolitan Museum of Art Open Access（CC0）
...
| **画家与画作** | 204 位画家档案，每位挂载本人代表作与逐幅赏析；可按时期/流派/地域筛选，支持「按画家」与「按作品」两种浏览模式 |
